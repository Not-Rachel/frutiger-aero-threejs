...
const tallTree = "/scavenger/assets/map-icons/tall-tree.webp";
const shortTree = "/scavenger/assets/map-icons/short-tree.webp";

const TreeItem = memo(({ tree, i }: any) => {
